...
- Pipeline based on Github actions:
    ...
    - Avoid LoadBalancer [issue caused by the AKS module](https://github.com/kubernetes/kubernetes/issues/73906#issuecomment-673674479) by [removing tag in infrastructure](/.github/workflows/iac-deploy.yaml#L106).
- Documentation.
